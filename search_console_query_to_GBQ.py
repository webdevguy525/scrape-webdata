...
project_id = 'high-service-231608' # Your Google Cloud project ID.
pkey = 'credentials.json' # see readme for help with creating the credentials and .json key.
my_table = 'SearchConsole.data_table' # see notes in the readme with regard to creating this table before running the script.
...
credentials = service_account.Credentials.from_service_account_file('high-service-231608-5350beca0aff.json')
